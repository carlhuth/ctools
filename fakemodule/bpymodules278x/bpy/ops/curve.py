def cyclic_toggle(*args, direction='CYCLIC_U'):
    ...
    :param direction: Direction, Direction to make surface cyclic in
        (type: enum in ['CYCLIC_U', 'CYCLIC_V'], (optional))
    :type direction: str
...
def delete(*args, type='VERT'):
    ...
    :param type: Type, Which elements to delete
        (type: enum in ['VERT', 'SEGMENT'], (optional))
    :type type: str
    :return: (type: enum set in {'RUNNING_MODAL', 'CANCELLED', 'FINISHED', 'PASS_THROUGH'})
    :rtype: set[str]
    """
...
def draw(*args, error_threshold=0.0, fit_method='REFIT', corner_angle=1.22173, use_cyclic=True, stroke=None, wait_for_input=True):
    ...
    :param fit_method: Fit Method
        ...
        * 'SPLIT': Split, Split the curve until the tolerance is met (fast).
        (type: enum in ['REFIT', 'SPLIT'], (optional))
    :type fit_method: str
...
def duplicate_move(*args, CURVE_OT_duplicate=None, TRANSFORM_OT_translate=None):
    ...
    :param CURVE_OT_duplicate: Duplicate Curve, Duplicate selected control points
        (type: CURVE_OT_duplicate, (optional))
    :type CURVE_OT_duplicate: CURVE_OT_duplicate
...
def extrude_move(*args, CURVE_OT_extrude=None, TRANSFORM_OT_translate=None):
    ...
    :param CURVE_OT_extrude: Extrude, Extrude selected control point(s)
        (type: CURVE_OT_extrude, (optional))
    :type CURVE_OT_extrude: CURVE_OT_extrude
    :param TRANSFORM_OT_translate: Translate, Translate (move) selected items
        (type: TRANSFORM_OT_translate, (optional))
    :type TRANSFORM_OT_translate: TRANSFORM_OT_translate
    :return: (type: enum set in {'RUNNING_MODAL', 'CANCELLED', 'FINISHED', 'PASS_THROUGH'})
...
def handle_type_set(*args, type='AUTOMATIC'):
    ...
    :param type: Type, Spline type
        (type: enum in ['AUTOMATIC', 'VECTOR', 'ALIGNED', 'FREE_ALIGN', 'TOGGLE_FREE_ALIGN'], (optional))
    :type type: str
    :return: (type: enum set in {'RUNNING_MODAL', 'CANCELLED', 'FINISHED', 'PASS_THROUGH'})
    :rtype: set[str]
    """
...
def normals_make_consistent(*args, calc_length=False):
...
def primitive_bezier_circle_add(*args, radius=1.0, view_align=False, enter_editmode=False, location=(0.0, 0.0, 0.0), rotation=(0.0, 0.0, 0.0), layers=(False, False, False, False, False, False, False, False, False, False, False, False, False, False, False, False, False, False, False, False)):
...
def primitive_bezier_curve_add(*args, radius=1.0, view_align=False, enter_editmode=False, location=(0.0, 0.0, 0.0), rotation=(0.0, 0.0, 0.0), layers=(False, False, False, False, False, False, False, False, False, False, False, False, False, False, False, False, False, False, False, False)):
...
def primitive_nurbs_circle_add(*args, radius=1.0, view_align=False, enter_editmode=False, location=(0.0, 0.0, 0.0), rotation=(0.0, 0.0, 0.0), layers=(False, False, False, False, False, False, False, False, False, False, False, False, False, False, False, False, False, False, False, False)):
...
def primitive_nurbs_curve_add(*args, radius=1.0, view_align=False, enter_editmode=False, location=(0.0, 0.0, 0.0), rotation=(0.0, 0.0, 0.0), layers=(False, False, False, False, False, False, False, False, False, False, False, False, False, False, False, False, False, False, False, False)):
...
def primitive_nurbs_path_add(*args, radius=1.0, view_align=False, enter_editmode=False, location=(0.0, 0.0, 0.0), rotation=(0.0, 0.0, 0.0), layers=(False, False, False, False, False, False, False, False, False, False, False, False, False, False, False, False, False, False, False, False)):
    """Construct a Path
...
def radius_set(*args, radius=1.0):
...
def select_linked_pick(*args, deselect=False):
...
def select_similar(*args, type='WEIGHT', compare='EQUAL', threshold=0.1):
    ...
    :param args: (override_context, execution_context, undo)
        ...
        undo (bool)
    :param type: Type
        (type: enum in ['TYPE', 'RADIUS', 'WEIGHT', 'DIRECTION'], (optional))
    :type type: str
...
def spin(*args, center=(0.0, 0.0, 0.0), axis=(0.0, 0.0, 0.0)):
...
def spline_type_set(*args, type='POLY', use_handles=False):
    ...
    :param args: (override_context, execution_context, undo)
        ...
        undo (bool)
    :param type: Type, Spline type
        (type: enum in ['POLY', 'BEZIER', 'NURBS'], (optional))
    :type type: str
...
def spline_weight_set(*args, weight=1.0):
...
def subdivide(*args, number_cuts=1):
...
def vertex_add(*args, location=(0.0, 0.0, 0.0)):
