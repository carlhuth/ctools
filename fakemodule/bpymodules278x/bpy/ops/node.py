def add_and_link_node(*args, type=”“, use_transform=False, settings=None, link_socket_index=0):
    ...
    :param settings: Settings, Settings to be applied on the newly created node
        (type: bpy_prop_collection of NodeSetting, (optional))
    :type settings: bpy_prop_collection
...
def add_reroute(*args, path=None, cursor=6):
    """Add a reroute node
...
def backimage_zoom(*args, factor=1.2):
...
def collapse_hide_unused_toggle(*args):
...
def detach_translate_attach(*args, NODE_OT_detach=None, TRANSFORM_OT_translate=None, NODE_OT_attach=None):
    ...
    :param NODE_OT_detach: Detach Nodes, Detach selected nodes from parents
        (type: NODE_OT_detach, (optional))
    :type NODE_OT_detach: NODE_OT_detach
    ...
    :param NODE_OT_attach: Attach Nodes, Attach active node to a frame
        (type: NODE_OT_attach, (optional))
    :type NODE_OT_attach: NODE_OT_attach
    :return: (type: enum set in {'RUNNING_MODAL', 'CANCELLED', 'FINISHED', 'PASS_THROUGH'})
    :rtype: set[str]
    """
    return {'FINISHED'}
...
def duplicate(*args, keep_inputs=False):
...
def duplicate_move(*args, NODE_OT_duplicate=None, NODE_OT_translate_attach=None):
    ...
    :param NODE_OT_duplicate: Duplicate Nodes, Duplicate selected nodes
        (type: NODE_OT_duplicate, (optional))
    :type NODE_OT_duplicate: NODE_OT_duplicate
    :param NODE_OT_translate_attach: Move and Attach, Move nodes and attach to frame
        (type: NODE_OT_translate_attach, (optional))
    :type NODE_OT_translate_attach: NODE_OT_translate_attach
    :return: (type: enum set in {'RUNNING_MODAL', 'CANCELLED', 'FINISHED', 'PASS_THROUGH'})
    :rtype: set[str]
    """
    return {'FINISHED'}
...
def duplicate_move_keep_inputs(*args, NODE_OT_duplicate=None, NODE_OT_translate_attach=None):
...
def group_edit(*args, exit=False):
    """Edit node group
...
def link_make(*args, replace=False):
...
def move_detach_links(*args, NODE_OT_links_detach=None, TRANSFORM_OT_translate=None, NODE_OT_insert_offset=None):
    ...
    :param NODE_OT_links_detach: Detach Links, Remove all links to selected nodes, and try to connect neighbor nodes together
        (type: NODE_OT_links_detach, (optional))
    :type NODE_OT_links_detach: NODE_OT_links_detach
    :param TRANSFORM_OT_translate: Translate, Translate (move) selected items
        (type: TRANSFORM_OT_translate, (optional))
    :type TRANSFORM_OT_translate: TRANSFORM_OT_translate
    :param NODE_OT_insert_offset: Insert Offset, Automatically offset nodes on insertion
        (type: NODE_OT_insert_offset, (optional))
    :type NODE_OT_insert_offset: NODE_OT_insert_offset
    :return: (type: enum set in {'RUNNING_MODAL', 'CANCELLED', 'FINISHED', 'PASS_THROUGH'})
    :rtype: set[str]
    """
    return {'FINISHED'}
...
def move_detach_links_release(*args, NODE_OT_links_detach=None, NODE_OT_translate_attach=None):
    """Move a node to detach links
...
def output_file_remove_active_socket(*args):
...
def read_fullsamplelayers(*args):
...
def select(*args, mouse_x=0, mouse_y=0, extend=False):
...
def select_border(*args, gesture_mode=0, xmin=0, xmax=0, ymin=0, ymax=0, extend=True, tweak=False):
...
def select_circle(*args, x=0, y=0, radius=1, gesture_mode=0):
...
def select_grouped(*args, extend=False, type=’TYPE’):
    ...
    :type extend: bool
    :param type: Type
        (type: enum in ['TYPE', 'COLOR', 'PREFIX', 'SUFFIX'], (optional))
    :type type: str
    :return: (type: enum set in {'RUNNING_MODAL', 'CANCELLED', 'FINISHED', 'PASS_THROUGH'})
    :rtype: set[str]
    """
...
def select_link_viewer(*args, NODE_OT_select=None, NODE_OT_link_viewer=None):
    ...
    :param NODE_OT_select: Select, Select the node under the cursor
        (type: NODE_OT_select, (optional))
    :type NODE_OT_select: NODE_OT_select
    :param NODE_OT_link_viewer: Link to Viewer Node, Link to viewer node
        (type: NODE_OT_link_viewer, (optional))
    :type NODE_OT_link_viewer: NODE_OT_link_viewer
    :return: (type: enum set in {'RUNNING_MODAL', 'CANCELLED', 'FINISHED', 'PASS_THROUGH'})
    :rtype: set[str]
    """
    return {'FINISHED'}
...
def select_same_type_step(*args, prev=False):
...
def translate_attach(*args, TRANSFORM_OT_translate=None, NODE_OT_attach=None, NODE_OT_insert_offset=None):
...
def translate_attach_remove_on_cancel(*args, TRANSFORM_OT_translate=None, NODE_OT_attach=None, NODE_OT_insert_offset=None):
    """Move nodes and attach to frame
...
def viewer_border(*args, gesture_mode=0, xmin=0, xmax=0, ymin=0, ymax=0, extend=True):
