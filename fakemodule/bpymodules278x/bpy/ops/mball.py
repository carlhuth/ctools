...
def duplicate_move(*args, MBALL_OT_duplicate_metaelems=None, TRANSFORM_OT_translate=None):
    ...
    :param MBALL_OT_duplicate_metaelems: Duplicate Metaelements, Duplicate selected metaelement(s)
        (type: MBALL_OT_duplicate_metaelems, (optional))
    :type MBALL_OT_duplicate_metaelems: MBALL_OT_duplicate_metaelems
...
def hide_metaelems(*args, unselected=False):
...
def select_similar(*args, type=’TYPE’, threshold=0.1):
    ...
    :param args: (override_context, execution_context, undo)
        ...
        undo (bool)
    :param type: Type
        (type: enum in ['TYPE', 'RADIUS', 'STIFFNESS', 'ROTATION'], (optional))
    :type type: str
