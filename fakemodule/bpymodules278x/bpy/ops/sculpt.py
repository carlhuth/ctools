...
def dynamic_topology_toggle(*args):
...
def sample_detail_size(*args, location=(0, 0)):
...
def uv_sculpt_stroke(*args, mode='NORMAL'):
    ...
    :param mode: Mode, Stroke Mode
        ...
        * 'RELAX': Relax, Switch brush to relax mode for duration of stroke.
        (type: enum in ['NORMAL', 'INVERT', 'RELAX'], (optional))
    :type mode: str
    :return: (type: enum set in {'RUNNING_MODAL', 'CANCELLED', 'FINISHED', 'PASS_THROUGH'})
    :rtype: set[str]
    """
