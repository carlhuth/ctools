...
def armature_layers(*args, layers=(False, False, False, False, False, False, False, False, False, False, False, False, False, False, False, False, False, False, False, False, False, False, False, False, False, False, False, False, False, False, False, False)):
...
def calculate_roll(*args, type='POS_X', axis_flip=False, axis_only=False):
    ...
    :param args: (override_context, execution_context, undo)
        ...
        undo (bool)
    :param type: Type
        (type: enum in ['POS_X', 'POS_Z', 'GLOBAL_POS_X', 'GLOBAL_POS_Y', 'GLOBAL_POS_Z', 'NEG_X', 'NEG_Z', 'GLOBAL_NEG_X', 'GLOBAL_NEG_Y', 'GLOBAL_NEG_Z', 'ACTIVE', 'VIEW', 'CURSOR'], (optional))
    :type type: str
...
def duplicate_move(*args, ARMATURE_OT_duplicate=None, TRANSFORM_OT_translate=None):
    ...
    :param ARMATURE_OT_duplicate: Duplicate Selected Bone(s), Make copies of the selected bones within the same armature
        (type: ARMATURE_OT_duplicate, (optional))
    :type ARMATURE_OT_duplicate: ARMATURE_OT_duplicate
...
def extrude_forked(*args, ARMATURE_OT_extrude=None, TRANSFORM_OT_translate=None):
    ...
    :param ARMATURE_OT_extrude: Extrude, Create new bones from the selected joints
        (type: ARMATURE_OT_extrude, (optional))
    :type ARMATURE_OT_extrude: ARMATURE_OT_extrude
    :param TRANSFORM_OT_translate: Translate, Translate (move) selected items
        (type: TRANSFORM_OT_translate, (optional))
    :type TRANSFORM_OT_translate: TRANSFORM_OT_translate
    :return: (type: enum set in {'RUNNING_MODAL', 'CANCELLED', 'FINISHED', 'PASS_THROUGH'})
...
def extrude_move(*args, ARMATURE_OT_extrude=None, TRANSFORM_OT_translate=None):
    """Create new bones from the selected joints and move them
...
def layers_show_all(*args, all=True):
...
def merge(*args, type='WITHIN_CHAIN'):
    ...
    :param args: (override_context, execution_context, undo)
        ...
        undo (bool)
    :param type: Type
        (type: enum in ['WITHIN_CHAIN'], (optional))
    :type type: str
    :return: (type: enum set in {'RUNNING_MODAL', 'CANCELLED', 'FINISHED', 'PASS_THROUGH'})
    :rtype: set[str]
    """
...
def parent_clear(*args, type='CLEAR'):
    ...
    :param type: ClearType, What way to clear parenting
        (type: enum in ['CLEAR', 'DISCONNECT'], (optional))
    :type type: str
    :return: (type: enum set in {'RUNNING_MODAL', 'CANCELLED', 'FINISHED', 'PASS_THROUGH'})
    :rtype: set[str]
    """
...
def parent_set(*args, type='CONNECTED'):
    ...
    :param type: ParentType, Type of parenting
        (type: enum in ['CONNECTED', 'OFFSET'], (optional))
    :type type: str
    :return: (type: enum set in {'RUNNING_MODAL', 'CANCELLED', 'FINISHED', 'PASS_THROUGH'})
    :rtype: set[str]
    """
...
def roll_clear(*args, roll=0.0):
    ...
    :param args: (override_context, execution_context, undo)
        ...
        undo (bool)
    :param roll: Roll
        (type: float in [-6.28319, 6.28319], (optional))
    :type roll: float
    :return: (type: enum set in {'RUNNING_MODAL', 'CANCELLED', 'FINISHED', 'PASS_THROUGH'})
    :rtype: set[str]
    """
...
def select_similar(*args, type='LENGTH', threshold=0.1):
    ...
    :param args: (override_context, execution_context, undo)
        ...
        undo (bool)
    :param type: Type
        (type: enum in ['CHILDREN', 'CHILDREN_IMMEDIATE', 'SIBLINGS', 'LENGTH', 'DIRECTION', 'PREFIX', 'SUFFIX', 'LAYER'], (optional))
    :type type: str
...
def symmetrize(*args, direction='NEGATIVE_X'):
    ...
    :param direction: Direction, Which sides to copy from and to (when both are selected)
        (type: enum in ['NEGATIVE_X', 'POSITIVE_X'], (optional))
    :type direction: str
    :return: (type: enum set in {'RUNNING_MODAL', 'CANCELLED', 'FINISHED', 'PASS_THROUGH'})
    :rtype: set[str]
    """
