...
def background_image_remove(*args, index=0):
...
def camera_to_view_selected(*args):
...
def clip_border(*args, xmin=0, xmax=0, ymin=0, ymax=0):
...
def dolly(*args, delta=0, mx=0, my=0):
...
def edit_mesh_extrude_individual_move(*args):
...
def edit_mesh_extrude_move_normal(*args):
...
def edit_mesh_extrude_move_shrink_fatten(*args):
...
def enable_manipulator(*args, translate=False, rotate=False, scale=False):
...
def layers(*args, nr=1, extend=False, toggle=True):
...
def pastebuffer(*args, autoselect=True, active_layer=True):
...
def render_border(*args, xmin=0, xmax=0, ymin=0, ymax=0, camera_only=False):
...
def select(*args, extend=False, deselect=False, toggle=False, center=False, enumerate=False, object=False, location=(0, 0)):
...
def snap_cursor_to_active(*args):
...
def snap_cursor_to_center(*args):
...
def snap_selected_to_active(*args):
...
def snap_selected_to_cursor(*args, use_offset=True):
...
def snap_selected_to_grid(*args):
...
def view_all(*args, use_all_regions=False, center=False):
...
def view_selected(*args, use_all_regions=False):
...
def zoom(*args, delta=0, mx=0, my=0):
