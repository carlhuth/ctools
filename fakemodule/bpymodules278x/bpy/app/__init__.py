...
binary_path_python = "/home/sui/bf/build_linux/bin/2.78/python/bin/python3.6m"
...
build_branch = b'master (modified)'
...
build_commit_date = b'2017-06-14'
"""The date of commit this blender instance was built"""

build_commit_time = b'20:47'
...
build_date = b'2017-06-16'
"""The date this blender instance was built"""

build_hash = b'df7c609fda9'
...
build_commit_timestamp = 1497473263
"""The unix timestamp of commit this blender instance was built"""

binary_path = "/home/sui/bf/build_linux/bin/blender"
...
build_options = None
"""constant value bpy.app.build_options(bullet=True, codec_avi=True, codec_ffmpeg=False, codec_quicktime=False, codec_sndfile=False, compositor=True, cycles=True, cycles_osl=False, freestyle=True, gameengine=True, image_cineon=True, image_dds=True, image_frameserver=True, image_hdr=True, image_openexr=True, image_openjpeg=True, image_tiff=True, input_ndof=True, audaspace=True, international=True, openal=True, sdl=False, sdl_dynload=False, jack=False, libmv=True, mod_boolean=True, mod_fluid=True, mod_oceansim=False, …)"""
