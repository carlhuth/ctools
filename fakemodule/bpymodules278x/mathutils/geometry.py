...
def box_fit_2d(points):
    ...
    :type points: bpy.types.ThemeSpaceListGeneric.list
    :return: angle
    :rtype: float
    """
...
def intersect_line_sphere(line_a, line_b, sphere_co, sphere_radius, clip=True):
    ...
    :type sphere_radius: bpy.types.FreestyleSettings.sphere_radius
    :return: The intersection points as a pair of vectors or None when there is no intersection
    :rtype: A tuple pair containing mathutils.Vector or None
    """
...
def normal(vectors):
    ...
    :param vectors: Vectors to calculate normals with
        (type: sequence of 3 or more 3d vector)
    :type vectors: collections.Sequence
