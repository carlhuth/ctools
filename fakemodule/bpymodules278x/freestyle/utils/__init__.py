...
from freestyle.types import StrokeVertexIterator, Interface0DIterator
...
def normal_at_I0D(it: Interface0DIterator):
    """"""


def pairwise(iterable, types="{<class 'StrokeVertexIterator'>, <class 'Stroke'>}"):
