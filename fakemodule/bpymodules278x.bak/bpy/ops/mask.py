def add_feather_vertex(*args, location=(0.0, 0.0)):
...
def add_feather_vertex_slide(*args, MASK_OT_add_feather_vertex=None, MASK_OT_slide_point=None):
    ...
    :param MASK_OT_add_feather_vertex: Add Feather Vertex, Add vertex to feather
        (type: MASK_OT_add_feather_vertex, (optional))
    :type MASK_OT_add_feather_vertex: MASK_OT_add_feather_vertex
    :param MASK_OT_slide_point: Slide Point, Slide control points
        (type: MASK_OT_slide_point, (optional))
    :type MASK_OT_slide_point: MASK_OT_slide_point
    :return: (type: enum set in {'RUNNING_MODAL', 'CANCELLED', 'FINISHED', 'PASS_THROUGH'})
    :rtype: set[str]
    """
    return {'FINISHED'}
...
def add_vertex(*args, location=(0.0, 0.0)):
...
def add_vertex_slide(*args, MASK_OT_add_vertex=None, MASK_OT_slide_point=None):
    ...
    :param MASK_OT_add_vertex: Add Vertex, Add vertex to active spline
        (type: MASK_OT_add_vertex, (optional))
    :type MASK_OT_add_vertex: MASK_OT_add_vertex
    :param MASK_OT_slide_point: Slide Point, Slide control points
        (type: MASK_OT_slide_point, (optional))
    :type MASK_OT_slide_point: MASK_OT_slide_point
    :return: (type: enum set in {'RUNNING_MODAL', 'CANCELLED', 'FINISHED', 'PASS_THROUGH'})
...
def duplicate_move(*args, MASK_OT_duplicate=None, TRANSFORM_OT_translate=None):
    ...
    :param MASK_OT_duplicate: Duplicate Mask, Duplicate selected control points and segments between them
        (type: MASK_OT_duplicate, (optional))
    :type MASK_OT_duplicate: MASK_OT_duplicate
...
def handle_type_set(*args, type='AUTO'):
    ...
    :param type: Type, Spline type
        (type: enum in ['AUTO', 'VECTOR', 'ALIGNED', 'ALIGNED_DOUBLESIDE', 'FREE'], (optional))
    :type type: str
    :return: (type: enum set in {'RUNNING_MODAL', 'CANCELLED', 'FINISHED', 'PASS_THROUGH'})
    :rtype: set[str]
    """
...
def normals_make_consistent(*args):
...
def primitive_circle_add(*args, size=100.0, location=(0.0, 0.0)):
...
def primitive_square_add(*args, size=100.0, location=(0.0, 0.0)):
...
def select(*args, extend=False, deselect=False, toggle=False, location=(0.0, 0.0)):
...
def shape_key_feather_reset(*args):
...
def shape_key_rekey(*args, location=True, feather=True):
...
def slide_point(*args, slide_feather=False, is_new_point=False):
